...
from fbnet.networks.layers.resnet.resnet_encoder_depth import ResnetEncoderDepth
from fbnet.networks.layers.resnet.depth_decoder import DepthDecoder
from fbnet.networks.layers.resnet.layers import disp_to_depth
...
class DepthResNet(nn.Module):
    ...
    def __init__(self, version=None, **kwargs):
        ...
        self.encoder = ResnetEncoderDepth(num_layers=num_layers, pretrained=pretrained)
